...
namespace Formatters.Bson
{
    ...
    /// <summary>
    /// A <see cref="NewtonsoftBsonInputFormatter"/> for BSON content
    /// </summary>
    public class NewtonsoftBsonInputFormatter : TextInputFormatter
    {
        ...
        public NewtonsoftBsonInputFormatter(
        ...
        public override Task<InputFormatterResult> ReadRequestBodyAsync(InputFormatterContext context, Encoding encoding)
        {
            ...
            using (var reader = new 
                BsonDataReader(request.Body)
                //BsonReader(request.Body)
                )
            {
        ...
        private JsonSerializer CreateJsonSerializer()
        {
            ...
            {
                _jsonSerializerPool = _objectPoolProvider.Create(new NewtonsoftBsonSerializerObjectPolicy(_jsonSerializerSettings));
            }
